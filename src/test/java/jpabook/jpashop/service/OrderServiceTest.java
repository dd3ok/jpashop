...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        // given
        Member member = createMember("injae");
    ...
    private Member createMember(String name) {
        ...
        member.setName(name);
        member.setAddress(new Address("SN", "BD", "12345"));
        em.persist(member);
        return member;
    }
    ...
    public void 주문취소() throws Exception {
        // given
        Member member = createMember("injae2");
        Item item = createItem("JPA2", 10000, 10);
        ...
        assertEquals("주문 취소된 상품은 재고가 증가함", 10, item.getStockQuantity());
